    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-black text-white flex items-center justify-center">
      <div className="text-center space-y-6">
        ...
        <div className="flex gap-4 justify-center mt-8">
          <button className="px-8 py-3 bg-neon-purple hover:bg-neon-pink transition-all rounded-lg font-semibold text-lg shadow-lg shadow-neon-purple/50">
            Explore Games
          </button>
          <button className="px-8 py-3 border-2 border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-black transition-all rounded-lg font-semibold text-lg">
            Start Comparing
          </button>
        </div>
      </div>
